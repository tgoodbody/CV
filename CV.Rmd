...
\begin{cvskills}
  \cvskill
    {Data Science}
    {R (Advanced: developed sgsR package), LAStools, lidR, ENVI, ARC/QGIS, ArcPy}

  \cvskill
    {Research}
    {Forest modelling, inventory analysis, lidar processing, digital aerial photogrammetry, raster analysis}
    
  \cvskill
    {Collaboration}
    {Extensive work with academic, government, and industry representatives}
