...
```{r EDUCATION}
structure(list(what = c("PhD Remote Sensing of Forests", "BSc Natural Resources Conservation with Honors"), when = structure(c("2019", "2015"
), class = c("glue", "character")), with = c("University of British Columbia", 
"University of British Columbia"), where = c("Vancouver, BC", 
"Vancouver, BC"), why = list("Assessing the role of digital aerial photogrammetry for characterizing forest structure and enhancing forest inventories", "Science and Management Major")), row.names = c(NA, 2L), groups = structure(list(
    what = c("BSc Natural Resources Conservation with Honors", 
    "High School Diploma", "PhD Remote Sensing of Forests"), when = structure(c("2017", 
    "2013", "2022"), class = c("glue", "character"
    )), with = c("University of British Columbia", 
    "University of British Columbia"), where = c("Vancouver, BC", "Vancouver, BC"
